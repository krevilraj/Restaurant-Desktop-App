...
public class TodayItemSoldTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TodayItemSoldTable frame = new TodayItemSoldTable();
					frame.setTitle("Today's sold Item ");
	...
	protected void populateData() {
		...
		List<ItemCountModel> sList = ss.getTableItemSoldToday();
