...
public class YesterdayItemSoldTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					YesterdayItemSoldTable frame = new YesterdayItemSoldTable();
					frame.setTitle("Yesterday's sold Item ");
	...
	protected void populateData() {
		...
		List<ItemCountModel> sList = ss.getTableItemSoldYesterday();
