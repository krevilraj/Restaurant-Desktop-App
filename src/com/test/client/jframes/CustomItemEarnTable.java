...
public class CustomItemEarnTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustomItemEarnTable frame = new CustomItemEarnTable();
					frame.setVisible(true);
					frame.setTitle("Custom Earn by Item ");
	...
	public void displayData(String start,String end) {
		...
		List<ItemEarnModel> sList = ss.getCustomEarnTable(start, end);
