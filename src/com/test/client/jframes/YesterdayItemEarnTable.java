...
public class YesterdayItemEarnTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					YesterdayItemEarnTable frame = new YesterdayItemEarnTable();
	...
	protected void populateData() {
		...
		List<ItemEarnModel> sList = ss.getTableItemEarnYesterday();
