...
public class ManagerOrders extends JPanel implements ActionListener {
	...
	public ManagerOrders() {
		...
		btnCancelOrder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(orderservice.deleteOrder(order_id)) {
					...
					ManagerDashboard.changeFrame(new ManagerOrders());
				}
			}
		});
		...
		panel_2.setLayout(null);
				...
				lblFilters.setFont(new Font("Calibri", Font.BOLD, 16));
						...
						categoryComboBox.setModel(new DefaultComboBoxModel(new String[] { "Category" }));
								...
								btnMain.setIcon(new ImageIcon(ManagerOrders.class.getResource("/image/btn_main.png")));
								...
								btnMain.setBackground(new Color(0, 102, 204));
										...
										btnDrinks.setIcon(new ImageIcon(ManagerOrders.class.getResource("/image/btn_drink.png")));
										...
										btnDrinks.setBackground(new Color(0, 102, 204));
												...
												panel_2.add(btnAll);
												btnAll.setIcon(new ImageIcon(ManagerOrders.class.getResource("/image/btn_all.png")));
		...
		label_33.setIcon(new ImageIcon(ManagerOrders.class.getResource("/image/orders.jpg")));
