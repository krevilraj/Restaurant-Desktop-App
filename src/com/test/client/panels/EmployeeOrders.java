...
import com.test.client.SalesPersonDashboard;
...
public class EmployeeOrders extends JPanel implements ActionListener {
	...
	public EmployeeOrders() {
		...
		btnAddToOrder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (orderValidation()) {
					...
					s.setTotal_price(Double.parseDouble(txt_price.getText()));
					s.setStatus("Pending");
		...
		btnProceedToKitchen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(validationTable()) {
					...
					SalesPersonDashboard.changeFrame(new EmployeeProcessOrders());
				}
		...
		btnCancelOrder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(orderservice.deleteOrder(order_id)) {
					...
					SalesPersonDashboard.changeFrame(new EmployeeOrders());
				}
			}
		});
		...
		panel_2.setLayout(null);
				...
				lblFilters.setFont(new Font("Calibri", Font.BOLD, 16));
						...
						categoryComboBox.setModel(new DefaultComboBoxModel(new String[] { "Category" }));
								...
								btnMain.setIcon(new ImageIcon(EmployeeOrders.class.getResource("/image/btn_main.png")));
								...
								btnMain.setBackground(new Color(0, 102, 204));
										...
										btnDrinks.setIcon(new ImageIcon(EmployeeOrders.class.getResource("/image/btn_drink.png")));
										...
										btnDrinks.setBackground(new Color(0, 102, 204));
												...
												panel_2.add(btnAll);
												btnAll.setIcon(new ImageIcon(EmployeeOrders.class.getResource("/image/btn_all.png")));
		...
		label_33.setIcon(new ImageIcon(EmployeeOrders.class.getResource("/image/orders.jpg")));
