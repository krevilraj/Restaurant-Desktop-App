...
public class ProcessOrders extends JPanel {
	...
	public ProcessOrders() {
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (order_id != -1) {
					String orderStatus = comboBoxStatus.getSelectedItem().toString();
		...
		label_5.setIcon(new ImageIcon(ProcessOrders.class.getResource("/image/calculator.png")));
		...
		JButton btnGenerateReciept = new JButton("Generate Reciept");
		btnGenerateReciept.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (order_id != -1) {           // check the order_id is set or not
					if (calculateGrandTotal()) {		// calculate the grandtotal
						
						/* Send all value to the Printer jFrame class and call displaybyId method of Printer class */
		...
		btnGenerateReciept.setBorder(null);
		btnGenerateReciept.setBackground(new Color(0, 102, 204));
		btnGenerateReciept.setBounds(183, 500, 115, 36);
		panel.add(btnGenerateReciept);
...
//		panel_1.setOpaque(false);
		...
		lblNewLabel.setIcon(new ImageIcon(ProcessOrders.class.getResource("/image/processorder.jpg")));
