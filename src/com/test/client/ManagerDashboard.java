...
import com.test.client.panels.ManagerOrders;
import com.test.client.panels.ManagerProcessOrders;
...
public class ManagerDashboard extends JFrame {
	...
	public ManagerDashboard() {
		...
		lblNewLabel.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/dashboard_logo.png")));
		...
		label.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/home.png")));
		...
		label_2 = new JLabel("");
		label_2.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/menu.png")));
		...
		label_4 = new JLabel("");
		label_4.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/drinks.png")));
		...
		pnl_tkorder.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				new CambiaPanel(main_panel, new ManagerOrders());
			}
		});
		...
		label_6 = new JLabel("");
		label_6.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/order.png")));
		...
		pnl_porder.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				new CambiaPanel(main_panel, new ManagerProcessOrders());
			}
		});
		...
		label_8 = new JLabel("");
		label_8.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/porder.png")));
		...
		pnl_stock.setBounds(0, 199, 223, 40);
		...
		label_12 = new JLabel("");
		label_12.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/stock.png")));
		...
		pnl_report.setBounds(0, 239, 223, 40);
		...
		label_14 = new JLabel("");
		label_14.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/report.png")));
		...
		pnl_logout.setBounds(0, 278, 223, 40);
		...
		label_18 = new JLabel("");
		label_18.setIcon(new ImageIcon(ManagerDashboard.class.getResource("/image/btn_logout.png")));
